...
function cardOlustur(veri) {
  ...
  var gelenUlke = document.createElement('p');
  var gelenEnlem = document.createElement('p');
  var gelenSehir = document.createElement('p');
  var gelenSaat = document.createElement('p');
  var gelenPara = document.createElement('p');
  var gelenIsp = document.createElement('p');
  imgCard.src = veri['ülkebayrağı'];
  cardInfo.classList.add('card-info');
  h3Ip.classList.add('ip');
  h3Ip.textContent = veri['sorgu'];
  gelenUlke.classList.add('ulke');
  gelenUlke.textContent = "".concat(veri['ülke'], " (").concat(veri['ülkeKodu'], ")");
  gelenEnlem.textContent = "Enlem: ".concat(veri['enlem'], " Boylam: ").concat(veri['boylam']);
  gelenSehir.textContent = "Sehir: ".concat(veri['şehir']);
  gelenSaat.textContent = "Saat dilimi: ".concat(veri['saatdilimi']);
  gelenPara.textContent = "Para birimi: ".concat(veri['parabirimi']);
  gelenIsp.textContent = "ISP: ".concat(veri['isp']);
